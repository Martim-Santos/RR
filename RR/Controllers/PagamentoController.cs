...
namespace RR.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,metodo")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,metodo")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
